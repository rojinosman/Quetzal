...
;
const metadata = {
    title: 'Project Falcon - Drone Build Journey',
    description: 'Follow our teams journey building a custom drone from scratch. View our progress, meet the team, and watch our first flight.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
